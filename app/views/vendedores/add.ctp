<?php
	...
	print $this->Form->create( "Vendedor", array( 'url' => array( 'controller' => 'vendedores', "action" => "add" ), "class" => "form" ) );
...
<table class="visualizar auto">
	...
	<tr>
		...
		<td class="input small"><?= $this->Form->input( "Vendedor.estado", array( 'label' => false, 'type' => 'select', 'escape' => false, 'class' => 'select small', 'empty' => '--', 'options' => $estado, 'default' => 'MA' ) ) ?></td>
	</tr>
	<tr>
		<td><?= $this->Form->label( "Vendedor.cidade", "Cidade:" ) ?></td>
		<td><?= $this->Form->input( "Vendedor.cidade", array( 'label' => false, 'class' => 'text', 'escape' => false, 'default' => 'São Luís' ) ) ?></td>
...
<table class="visualizar auto">
	...
	<tr>
		<td colspan="2"><?= $this->element( "submit", array( 'cancel' => '/vendedores' ) ) ?></td>
	</tr>
</table>
